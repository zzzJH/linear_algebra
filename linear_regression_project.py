...
# TODO 证明:
# $$
# \frac{\partial E} {\partial m} = {\frac{1} {2}{(y_i - mx_i - b)^2}}
# $$
# 
# $$
# \frac{\partial E} {\partial m} = {\frac{1} {2}{(y_i - mx_i - b)(y_i - mx_i - b)}}
# $$
# 
# $$
# \frac{\partial E} {\partial m} = {\frac{1} {2}(y_i^2 + m^2x_i^2 + b^2 - 2y_imx_i + 2mx_ib - 2y_ib})
# $$
# 
# $$
# \frac{\partial E} {\partial m} = {\frac{1} {2}(2mx_i^2 - 2y_ix_i + 2x_ib})
# $$
# 
# $$
# \frac{\partial E} {\partial m} = mx_i^2 - y_ix_i + x_ib
# $$
# 
# $$
# \frac{\partial E} {\partial m} = -x_i(y_i - mx_i- b)
# $$

# $$
# \frac{\partial E} {\partial b} = {\frac{1} {2}{(y_i - mx_i - b)^2}}
# $$
# 
# $$
# \frac{\partial E} {\partial b} = {\frac{1} {2}{(y_i - mx_i - b)(y_i - mx_i - b)}}
# $$
# 
# $$
# \frac{\partial E} {\partial b} = {\frac{1} {2}(y_i^2 + m^2x_i^2 + b^2 - 2y_imx_i + 2mx_ib - 2y_ib})
# $$
# 
# $$
# \frac{\partial E} {\partial b} = {\frac{1} {2}(2b + 2mx_i - 2y_i})
# $$
# 
# $$
# \frac{\partial E} {\partial b} = b + mx_i - y_i
# $$
# 
# $$
# \frac{\partial E} {\partial b} = -(y_i - mx_i - b)
# $$
